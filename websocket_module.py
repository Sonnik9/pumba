...
async def price_volume_monitoring(coins_in_squeezeOn_arg, PRICE_KLINE_1M_PERCENT_CHANGE, VOLUME_KLINE_1M_MULTIPLITER):
                                            ...
                                            for y in process_list:
                                                if x["symbol"] == y["symbol"]:
                                                    if x["volume_1m_mean"] != 0 and y["last_volume"] !=0 and x["close_1m_mean"] != 0:
                                                        ...
                                                        coins_in_squeezeOn[i]["close_1m_mean"] = ((x["close_1m_mean"]* 4) + y["last_close_price"]) / 5
                                                        coins_in_squeezeOn[i]["volume_1m_mean"] = ((x["volume_1m_mean"] * 4) + y["last_volume"]) / 5
